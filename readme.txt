=== Direct Pay Online for Woocommerce ===
Contributors: Direct Pay Online
Description:  Online payments plug in powered by Direct Pay Online (3G Direct Pay Limited), credit cards, PayPal and Mobile Money
Author: Direct Pay Online
Author URI: http://www.directpay.online/
Tags: woocommerce, e-commerce, direct pay, direct pay online
Version: 1.0.8
...
Online payments plug in powered by Direct Pay Online (3G Direct Pay Limited), credit cards, PayPal and Mobile Money

== Description ==

Direct Pay Online provides a safe and secure payments plugin for WooCommerce, the plugin connected the WooCommerce to an online payments service which supports all mode of payments, Credit cards, PayPal, and Mobile Money, bank transfers and more, it's a multi currency service which can accept any payment from anywhere in the world. 
Direct Pay Online payments service is a PCI DSS Level 1 certified and included with the latest fraud prevention and risk management features. 
...
3. Activate the Direct Pay Online for WooCommerce plugin through the 'Plugins' screen in WordPress.
4. Use WooCommerce settings-> checkout tab -> Direct Pay Online Settings to configure the plugin.


== Frequently Asked Questions ==

= Do I have to be a Direct Pay Online customer to use the plugin? =

Yes, you need an online account with Direct Pay online to use the plugin. 
...
= Can the Direct Pay Online plugin work without an ecommerce plugin? =
...
= Can the Direct Pay Online plugin work with all ecommerce plugins in wordpress? =

Yes, wordpress has many ecommerce plugins to choose from that can suit your business and they are all compatible with the Direct Pay Online plugin.

= Can the plugin work with websites built on other (CMS) Content Management Systems? =

The plugin is specifically designed for wordpress, however 3G Direct Pay has an amazing API that can integrate with any website in the world! Contact us **sales@directpay.online** to get started today.
...
= There is no Direct Pay payment option on checkout page =

Check 3G Direct Pay Plugin setting. Simply, go to your admin panel, select WooCommerce > Settings >Checkout tab > Direct Pay Online, Check if Enable 3G Direct Pay checkbox is checked.
...
Means that the 3G URL  address in Direct Pay Plugin setting is incorrect. You need to verify that 3G URL address that you received from 3G team is defined property. 
...
1. Check that woocommerce and direct pay online plugins are activated properly.
2. Check Direct Pay Online settings:
   * Checkbox Enable Direct Pay Online must be checked
   * Company token must be defined correctly and be the same as you received from Direct Pay Online
   * 3G URL must be  https://secure.3gdirectpay.com
3. Check product settings
   * Verify that the Direct Pay service type is defined and is numeric only. This number must be the same as you received from Direct Pay Online. Each product or service must have service type number.
4. After you checked the settings and verify that all the fields are defined correctly but the problem not solved, please contact the Direct Pay Online support for additional help.
...
2.  Click on Direct Pay to edit the settings. If you do not see Direct Pay Online in the list at the top of the screen make sure you have activated the plugin in the WordPress Plugin Manager.
3.  Enable Direct Pay Online Method.
4.  In the title field, name it Direct Pay Online (this will show up on the payment page your customer sees).
5.  Insert Company Token (mandatory). This number you will receive from Direct Pay Online.
6.  Insert 3G URL (mandatory). This is payment gateway url that you will receive from Direct Pay Online.
...
11. Service type is mandatory fields. For each product you must insert the service type number according to the options accepted from Direct Pay Online.
