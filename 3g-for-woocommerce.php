...
/**
 *
 * Plugin Name:       Direct Pay Online for Woocommerce
 ...
 * Copyright:         © 2016 Direct Pay Online.
 *
 *
...
if ( !in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' )))) {
   ...
   wp_die( "<strong>Direct Pay Online</strong> requires <strong>WooCommerce</strong> plugin to work normally. Please activate it or install it from <a href=\"http://wordpress.org/plugins/woocommerce/\" target=\"_blank\">here</a>.<br /><br />Back to the WordPress <a href='".get_admin_url(null, 'plugins.php')."'>Plugins page</a>." );
}

add_action('plugins_loaded', 'woocommerce_3g_init');

//Main 3G Direct Pay plugin function
function woocommerce_3g_init(){
	...
	class WC_Gateway_3G extends WC_Payment_Gateway {
		...
		const VERSION_3G = '1.0.8';

		protected $default_image = 'http://www.directpay.online/wp-content/uploads/2016/04/mobile_295x54-2.png';
		...
		public function __construct(){
			...
			$this->method_title 	  = 'Direct Pay Online';
        ...
        public function init_form_fields(){
			...
			$this->form_fields = array(
				...
				'enabled' => array(
					...
					'type'        => 'checkbox',
					'label'   	  => __( 'Enable Direct Pay Online', 'woocommerce' ),
					'default'     => 'yes'
				),
				'title' => array(
					...
					'default'     => __( '3G Direct Pay', 'woocommerce' ),
					'desc_tip'    => true,
				),
				'company_token' => array(
				...
				'is_default_img' => array(
					...
					'type'        => 'checkbox',
					'label'   	  => __( 'Use default Direct Pay Online checkout image', 'woocommerce' ),
		...
		//WooCommerce 3G Direct pay settings html
		public function admin_options() {
			?>
				<h2><?php _e('Direct Pay Online','woocommerce'); ?></h2>
...
function custom_tab_options_tab() {
	?>
		<li class="custom_tab"><a href="#3g_service_tab_data"><?php _e('Direct Pay Service Type', 'woothemes'); ?></a></li>
	<?php
}
